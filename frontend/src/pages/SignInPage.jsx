        ...
        <div className="w-full max-w-lg">
          <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/60">
            <div className="px-8 py-10 sm:px-10 sm:py-12">
              <h2 className="text-center text-3xl font-extrabold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Sign in to your account</h2>
